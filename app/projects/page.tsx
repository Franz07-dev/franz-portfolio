...
const projectSections: ProjectSection[] = [
  {
    ...
    projects: [
      {
        title:       "Task Manager",
        desc:        "A full-stack productivity app with authentication, task filtering, and persistent storage backed by PostgreSQL.",
        learned:     "Full-stack flow: API routes → Prisma ORM → PostgreSQL on Neon. Auth with NextAuth.js, password hashing with bcrypt, and JWT sessions.",
        status:      "Live",
        image:       "/task-manager.png",
        externalHref: "https://task-manager-three-tau-18.vercel.app",
        featured:    true,
        tags:        ["Next.js", "PostgreSQL", "Prisma", "NextAuth", "Full-stack"],
      },
      {
        title:       "Code Explainer",
        desc:        "An interactive AI-powered tool that breaks down and explains code snippets with insights and examples.",
        learned:     "Integrating local AI services, building explanatory UIs, and handling dynamic code rendering.",
        status:      "Live",
        image:       "/code-explainer.png",
        externalHref: "https://code-explainer-sandy.vercel.app",
        featured:    true,
        tags:        ["Next.js", "AI", "Code Tools"],
      },
      {
        title:       "Weather App",
  ...
  },
  {
    ...
    projects: [
      ...
      },
      {
        ...
        desc:     "Write Markdown on the left, see a live rendered preview on the right instantly.",
        learned:  "Parsing and rendering Markdown safely in React, and building a split-pane editor layout.",
        status:   "Live",
...

  {
    ...
    projects: [
      ...
      },
      {
        ...
        tags:    ["JavaScript", "Text Analysis", "Utilities"],
      },
    ],
  },
];
